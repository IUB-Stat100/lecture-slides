...
crime_long %>% filter(name != "United.States.Total") %>%
  ...
  ylab('violent crimes per 100K people') + theme_cowplot() +
...
```{r ucr-national}
crime_long %>% filter(name == "United.States.Total") %>%
  ggplot(aes(Year, value)) + geom_line(color=purple) +
  ylab('violent crimes per 100K people') + theme_cowplot() +
  theme(legend.title = element_blank())
```
...
g1 = ggplot(df, aes(x,y,fill=x)) + geom_tile() + scale_fill_brewer(palette = "Greys") +
  theme_map(12) + ggtitle("Sequential greyscale") + theme(legend.position = 'none')
g2 = ggplot(df, aes(x,y,fill=x)) + geom_tile() + scale_fill_brewer() +
  theme_map(12) + ggtitle("Sequential blue") + theme(legend.position = 'none')
g3 = ggplot(df, aes(x,y,fill=x)) + geom_tile() + scale_fill_manual(values=terrain.colors(5)) +
  theme_map(12) + ggtitle("Sequential terrain") + theme(legend.position = 'none')
g4 = ggplot(df, aes(x,y,fill=x)) + geom_tile() + scale_fill_brewer(palette = 'RdBu') +
  theme_map(12) + ggtitle("Diverging") + theme(legend.position = 'none')
g5 = ggplot(df, aes(x,y,fill=x)) + geom_tile() + scale_fill_brewer(palette = 'Set1') +
  theme_map(12) + ggtitle("Unordered") + theme(legend.position = 'none')
g6 = ggplot(df, aes(x,y,fill=x)) + geom_tile() + scale_fill_viridis_d() +
  theme_map(12) + ggtitle("Colorblind safe") + theme(legend.position = 'none')
...
# Check "Teaching stats: a bag of tricks"
